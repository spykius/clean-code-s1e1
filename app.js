...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.classList.add("input-text", "tasks__input");

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.classList.add("btn-primary", "btn-primary_editable", "tasks__btn-primary");

    deleteButton.classList.add("btn-primary", "btn-delete", "tasks__btn-delete");
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".btn-primary_editable");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".btn-primary_editable");
